    ...
    <div class="app-main">
      <div class="capability">
        <div class="capa-detail">
          <div class="ui-sidebar capa-sidebar">
          ...
          <div class="main-section">
            <div class="capa-detail-bread ui-paper">
              ...
              {{list[currentIndex1].label}} &gt; {{list[currentIndex1].children[currentIndex2].label}}
            </div>
            <div class="capa-detail-banner ui-paper banner-1">
              <p class="capa-detail-banner__title">{{list[currentIndex1].children[currentIndex2].label}}</p>
              <p class="capa-detail-banner__desc">
                {{list[currentIndex1].children[currentIndex2].content}}
              </p>
            ...
            <div class="capa-detail-apiList ui-paper">
              <div class="capa-detail-apiList__title">API列表</div>
              <a
                _stat_click_id="apilist_card"
                href="/doc/nlpbase.shtml"
                target="_blank"
                class="ui-card capa-card card-1"
                ><p class="capa-card__title">分词</p>
                <p class="capa-card__desc">
                  对文本进行智能分词识别，支持基础词与混排词粒度
                </p>
                <p class="capa-card__more">查看文档 &gt;</p></a
              ><a
                _stat_click_id="apilist_card"
                href="/doc/nlp_wordpos.shtml"
                target="_blank"
                class="ui-card capa-card card-1"
                ><p class="capa-card__title">词性</p>
                <p class="capa-card__desc">
              ...
              ><a
                ...
                target="_blank"
                class="ui-card capa-card card-1"
                ><p class="capa-card__title">专有名词</p>
                <p class="capa-card__desc">
              ...
              ><a
                ...
                target="_blank"
                class="ui-card capa-card card-1"
                ><p class="capa-card__title">同义词</p>
                <p class="capa-card__desc">
            ...
            <div class="sec capa-detail-qps">
              <div class="sec-header">
                <div class="sec-header__title">调用量限额</div>
                <div class="sec-header__action">
                  <div>
                    <span style="font-size: 14px;">实名认证可提高QPS限额</span
                    ><a
                      _stat_click_id="table_gotoauth"
              ...
              <div class="sec-content">
                <div class="capa-detail-qps__content">
                  <table class="ui-table">
                    <thead class="ui-table__head">
                      <tr class="ui-table__row">
                        <td class="ui-table__cell" style="min-width: 160px;">
                          API
                        </td>
                        <td class="ui-table__cell" style="min-width: 160px;">
                          免费调用量限额
                        ...
                        <td class="ui-table__cell" style="min-width: 160px;">
                          ...
                          <div class="ui-tooltip">
                            <div class="ui-tooltip-icon">
                              ...
                              >
                                <p>未认证用户每秒可调用该接口的次数上限</p>
                              </div>
                            </div>
                          </div>
                        </td>
                        <td class="ui-table__cell" style="min-width: 165px;">
                          QPS限额（个人认证）
                          <div class="ui-tooltip">
                            <div class="ui-tooltip-icon">
                              <div
                    ...
                    <tbody class="ui-table__body">
                      <tr class="ui-table__row ui-table__row_border">
                        ...
                        <td class="ui-table__cell">不限额</td>
              ...
              >
                ...
                <div class="ui-dialog-body">
                  <div class="success-dialog-body">
                    <i class="success-dialog-logo"></i>
                    <div class="success-dialog-title">能力已开通</div>
                    <div class="success-dialog-desc">
                      <p>
                        请查看文档，并根据文档提示进行调试，以完成能力的完整接入。接入成功后，在<span
                        ></span>应用中可以查看该能力的详细运行情况。
                      </p>
                    </div>
                    <div class="success-dialog-btn">
                      <a
                        class="ui-button ui-button-primary is-blue success-dialog-doc"
                        href="/doc/nlpbase.shtml"
                        target="_blank"
                        >查看文档</a
                      ><a

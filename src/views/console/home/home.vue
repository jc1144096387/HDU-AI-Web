<template>
  <div class="app">
      ...
      <div class="layout">
        ...
        <div class="header-center">
          <ul class="header-nav">
            ...
            <li class="header-nav-first nav-more app-nav" :class="isNavShow?'hover-nav':''" @mouseenter="showNav()" @mouseleave="hideNav()">
              <a
                ...
                <ul>
                  ...
                  <li class="app-nav-item">
                    <a
                      ...
                      ><span class="text-overflow" title="小程序"
                        >小程序</span
                      ></a
                    ><i
          ...
          <div class="header-user">
            <div class="header-user-name nav-more user-nav">
              <a
                ...
                ><span class="text-overflow">成</span></a
              >
    ...
    <!-- 底部版权信息 -->
    <div class="ai-footer footer" style="padding-left: 0px;">
      Copyright © 2020 - 2020 HDUAI. All Rights Reserved.
    </div>
  </div>
</template>
<script>

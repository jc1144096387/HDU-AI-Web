...
// 设置技术引擎产品列表
export const SET_PRODUCT_LIST = (state, data) => {
  state.productList = data;
};

// 设置用户的应用列表
export const SET_APP_LIST = (state, data) => {
  state.appList = data;
};
...
//   const info = {
//     data: data,
//     exp: new Date().getTime() + (3600 * 60 * 1000)//有效期
//   };
...
// // 设置商品类型列表
// export const SET_GOODS_TYPE_LIST = (state, data) => {
//   state.goodsTypeList = data;
// };
// // 设置热销商品列表
// export const SET_HOT_GOODS_LIST = (state, data) => {
...
// };
// // 修改购物车信息
// export const EDIT_SHOPPING_CART = (state, data) => {
//   state.shoppingCart[data.index].cartData.num = data.params.num;
// };
// // 删除购物车信息
// export const DELETE_SHOPPING_CART = (state, data) => {
//   state.shoppingCart.splice(data,1);
// };

// // 更新用户信息
// export const FLASH_USER_INFO = (state, data) => {
//   const info = localStorage.getItem('info');
//   state.userInfo = info === null ? null : JSON.parse(info);
// };
// // 用户登出
